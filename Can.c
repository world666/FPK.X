...
//Set Filters
    ...
    CAN1SetFilter(0, CAN_FILTER_SID(0x80) & CAN_RX_EID_DIS, CAN_FILTER_EID(00000));
    CAN1SetMask(0, CAN_MASK_SID(0xF8) & CAN_MATCH_FILTER_TYPE, CAN_MASK_EID(00000));
...
//Set Filters
    long node_id = _nodeId;
    CAN2SetFilter(0, CAN_FILTER_SID(0x180) & CAN_RX_EID_DIS, CAN_FILTER_EID(00000));
    CAN2SetMask(0, CAN_MASK_SID(0x7FC) & CAN_MATCH_FILTER_TYPE, CAN_MASK_EID(00000));
